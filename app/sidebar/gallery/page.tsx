      ...
      <main className={styles.main}>
        ...
        {loading ? (
          ...
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptyText}>Aún no hay imágenes en la galería.</p>
            <p className={styles.emptySubtext}>Las imágenes guardadas por los usuarios aparecerán aquí.</p>
          </div>
        ) : (
          <>
