...
const OUTFIT_OPTIONS_ALL = [
  ...
  { value: 'sexy and revealing nurse uniform, at a hospital room',                                label: 'Enfermera Sexy',      mode: 'nsfw' },
  { value: 'sexy and revealing secretary outfit and glasses, at a office',                        label: 'Secretaria Sensual',     mode: 'nsfw' },
  { value: 'revealing, glossy black latex catsuit, in the balcony of a luxurious penthouse overlooking the glowing city at night',                            label: 'Gatúbela',      mode: 'nsfw' },
